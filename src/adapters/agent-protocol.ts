...
export {
  createToolRestHandler as createAgentProtocolHandler,
  type ToolRestHandler as AgentProtocolHandler,
  type RestTool as AgentTool,
  type RestToolExecutionResult as ToolExecutionResult,
  type RestToolError as ToolError,
  type RestToolResult as ToolResult,
