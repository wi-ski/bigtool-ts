...
export interface ToolRestHandler {
     ...
     */
    executeTool(name: string, args: Record<string, unknown>): Promise<RestToolResult<RestToolExecutionResult>>;
}
/**
 ...
 * ```
 */
export declare function createToolRestHandler(config: AdapterConfig): ToolRestHandler;
